...
'api.v1.reviews.destroy','api.v1.products.reviews.reactions.store','api.v1.variations.index','api.v1.orders.latest','api.v1.orders.invoice',
'api.v1.orders.index','api.v1.orders.store','api.v1.orders.show','api.v1.orders.update','api.v1.reviews.index',
'api.v1.reviews.store','api.v1.messages.index','api.v1.messages.store','api.v1.messages.show','api.v1.messages.update',
'api.v1.messages.destroy','api.v1.articles.updateSearchIndexes','api.v1.articles.index','api.v1.articles.store','api.v1.articles.show',
'api.v1.articles.update','api.v1.articles.destroy','api.v1.search','api.','api.',
