        ...
        >
            <div class="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                ...
                <ul class="flex flex-wrap gap-4 mt-16">
                    <li
                        class="flex items-center justify-center w-10 h-10 bg-gray-800 rounded-full hover:bg-gray-900 shrink-0"
                    >
                    ...
                    <div class="grid gap-8 sm:grid-cols-2">
                        <div class="relative flex items-center">
                            <input
                                ...
                                class="w-full px-2 py-3 text-sm text-gray-800 bg-white border-b border-gray-300 outline-none focus:border-blue-500"
                            />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="#bbb"
                        ...
                        <div class="relative flex items-center">
                            <input
                                ...
                                class="w-full px-2 py-3 text-sm text-black text-gray-800 bg-white border-b border-gray-300 outline-none focus:border-blue-500"
                            />
                            <svg
                                fill="#bbb"
                                class="w-[18px] h-[18px] absolute right-2"
                        ...
                        <div class="relative flex items-center sm:col-span-2">
                            <textarea
                                ...
                                class="w-full px-2 pt-3 text-sm text-black text-gray-800 bg-white border-b border-gray-300 outline-none focus:border-blue-500"
                            ></textarea>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="#bbb"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="flex gap-6 mt-4 max-lg:flex-col">
                                <div class="flex items-center">
                                    ...
                                    >
                                        <span
                                            class="border-[4px] border-[#011c2b] rounded-full w-full h-full"
                                        ></span>
                                    </label>
