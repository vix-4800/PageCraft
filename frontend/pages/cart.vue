            ...
            <div class="p-4 bg-gray-100 rounded-md h-max">
                ...
                <ul class="mt-6 space-y-3 text-gray-800">
                    <li class="flex flex-wrap gap-4 text-sm">
                        Subtotal
                        <span class="ml-auto font-bold">$200.00</span>
                    </li>
                    <li class="flex flex-wrap gap-4 text-sm">
                        Shipping
                ...
                <div class="mt-6 space-y-3">
                    ...
                    <nuxt-link
                        to="/"
                        type="button"
                        class="block text-center text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent text-gray-800 border border-gray-300 rounded-md"
                    >
                        Continue Shopping
                    </nuxt-link>
                </div>
