...
'services.google.redirect','services.sdek.client_id','services.sdek.client_secret','services.boxberry.token','services.telegram.bot_token',
'services.telegram.chat_id','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','TELEGRAM_BOT_TOKEN',
'TELEGRAM_CHAT_ID',);
