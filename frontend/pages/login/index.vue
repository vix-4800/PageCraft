<template>
    <div>
        ...
        >
            ...
            <u-form-field name="password" size="lg">
                <u-input
        ...
        <div class="flex justify-center gap-4">
            <u-button
                class="bg-gray-800 border border-gray-600 rounded-lg shadow-xl hover:ring-1 te focus:outline-hidden focus:ring-2 focus:ring-gray-500 hover:bg-gray-700"
                size="lg"
                label="Email Code"
                icon="ri:mail-line"
