...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'scout.meilisearch.index-settings.App\Models\Article.filterableAttributes' => 'string',
            'scout.meilisearch.index-settings.App\Models\Article.sortableAttributes' => 'string',
...
'fortify.features','laravolt.avatar.driver','laravolt.avatar.generator','laravolt.avatar.ascii','laravolt.avatar.shape',
'laravolt.avatar.width','laravolt.avatar.height','laravolt.avatar.chars','laravolt.avatar.fontSize','laravolt.avatar.uppercase',
'laravolt.avatar.rtl','laravolt.avatar.fonts','laravolt.avatar.foregrounds','laravolt.avatar.backgrounds','laravolt.avatar.border.size',
'laravolt.avatar.border.color','laravolt.avatar.border.radius','laravolt.avatar.theme','laravolt.avatar.themes.grayscale-light.backgrounds','laravolt.avatar.themes.grayscale-light.foregrounds',
'laravolt.avatar.themes.grayscale-dark.backgrounds','laravolt.avatar.themes.grayscale-dark.foregrounds','laravolt.avatar.themes.colorful.backgrounds','laravolt.avatar.themes.colorful.foregrounds','laravolt.avatar.themes.pastel.backgrounds',
'laravolt.avatar.themes.pastel.foregrounds','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.markdown.paths','purify.default','purify.configs.default.Core.Encoding','purify.configs.default.HTML.Doctype','purify.configs.default.HTML.Allowed',
...
'purify.css-definitions','purify.serializer.driver','purify.serializer.cache','queue.default','queue.connections.sync.driver',
...
'scout.meilisearch.index-settings.App\\Models\\Product.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Product.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Article.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Article.sortableAttributes','scout.typesense.client-settings.api_key',
...
'services.github.client_id','services.github.client_secret','services.github.redirect','services.github.repo','services.google.client_id',
'services.google.client_secret','services.google.redirect','services.sdek.client_id','services.sdek.client_secret','services.boxberry.token',
'services.telegram.bot_token','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'api.v1.reports.','api.v1.settings.show','api.v1.settings.update','api.v1.templates.show','api.v1.templates.update',
'api.v1.','api.v1.','api.v1.','api.v1.','api.v1.products.index',
'api.v1.products.store','api.v1.products.show','api.v1.products.update','api.v1.products.destroy','api.v1.products.reviews.index',
'api.v1.products.reviews.store','api.v1.reviews.show','api.v1.reviews.update','api.v1.reviews.destroy','api.v1.variations.index',
'api.v1.','api.v1.','api.v1.','api.v1.orders.index','api.v1.orders.store',
'api.v1.orders.show','api.v1.orders.update','api.v1.reviews.index','api.v1.reviews.store','api.v1.messages.index',
'api.v1.messages.store','api.v1.messages.show','api.v1.messages.update','api.v1.messages.destroy','api.v1.',
'api.v1.articles.index','api.v1.articles.store','api.v1.articles.show','api.v1.articles.update','api.v1.articles.destroy',
'api.v1.','api.v1.banners.show','api.v1.banners.update','storage.local',);
