...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','sanctum.csrf-cookie','telescope','api.user.',
'api.user.','api.user.','api.user.addresses.index','api.user.addresses.store','api.user.addresses.show',
'api.user.addresses.update','api.user.addresses.destroy','api.user.','api.user.','api.user.',
'api.oauth.','api.oauth.','api.','api.','api.v1.users.index','api.v1.users.store','api.v1.users.show','api.v1.users.update',
'api.v1.users.destroy','api.v1.','api.v1.statistics.','api.v1.statistics.','api.v1.backup.',
'api.v1.backup.','api.v1.backup.','api.v1.backup.','api.v1.backup.','api.v1.log.',
'api.v1.log.','api.v1.log.','api.v1.log.','api.v1.accounts.index','api.v1.accounts.store',
'api.v1.accounts.show','api.v1.accounts.update','api.v1.accounts.destroy','api.v1.reports.','api.v1.reports.',
'api.v1.versions.','api.v1.settings.show','api.v1.settings.update','api.v1.templates.show','api.v1.templates.update',
