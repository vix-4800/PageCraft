...
namespace Illuminate\Http\Client {
    ...
    class Factory {
         ...
         * @param \App\Models\MarketplaceAccount $marketplaceAccount
         * @return \Illuminate\Http\Client\PendingRequest 
         * @static 
         */
        public static function ozon($marketplaceAccount)
        {
            return \Illuminate\Http\Client\Factory::ozon($marketplaceAccount);
        }
         ...
         * @static 
         */
        public static function wildberries($marketplaceAccount)
        {
            return \Illuminate\Http\Client\Factory::wildberries($marketplaceAccount);
        }
         ...
         * @static 
         */
        public static function yandex($marketplaceAccount)
        {
            return \Illuminate\Http\Client\Factory::yandex($marketplaceAccount);
        }
