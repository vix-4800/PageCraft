...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','reverb.default',
...
'api.v1.backup.delete','api.v1.log.','api.v1.log.','api.v1.log.','api.v1.log.',
'api.v1.accounts.index','api.v1.accounts.store','api.v1.accounts.show','api.v1.accounts.update','api.v1.accounts.destroy',
'api.v1.','api.v1.settings.show','api.v1.settings.update','api.v1.templates.show','api.v1.templates.update',
'api.v1.products.best','api.v1.products.new','api.v1.products.popular','api.v1.products.updateSearchIndexes','api.v1.products.index',
'api.v1.products.store','api.v1.products.show','api.v1.products.update','api.v1.products.destroy','api.v1.products.reviews.index',
'api.v1.products.reviews.store','api.v1.reviews.show','api.v1.reviews.update','api.v1.reviews.destroy','api.v1.products.reviews.reactions.store',
'api.v1.variations.index','api.v1.orders.latest','api.v1.orders.invoice','api.v1.orders.index','api.v1.orders.store',
'api.v1.orders.show','api.v1.orders.update','api.v1.reviews.index','api.v1.reviews.store','api.v1.messages.index',
'api.v1.messages.store','api.v1.messages.show','api.v1.messages.update','api.v1.messages.destroy','api.v1.articles.updateSearchIndexes',
'api.v1.articles.index','api.v1.articles.store','api.v1.articles.show','api.v1.articles.update','api.v1.articles.destroy',
'api.v1.search','api.v1.banner.show','api.v1.banner.update','api.','api.',
'api.','api.user.notifications','api.user.notifications.read','api.oauth.redirect','api.oauth.callback','storage.local',);
